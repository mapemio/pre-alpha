...
//		echo '<a href="#" onclick="mapaQueen();">.- GO ->.</a>';		
		echo '<a href="#" class="noBlueLinks" onclick="URL1 =\'../maps/'.$pn[$i].'/\'; setMapURLforUploadImages(); $(\'#draggable\').html(\'\'); jumpTo(1, 1); dibuja(); iniciaMiniMap();"><img src="'.'../maps/'.$pn[$i].'/data/mini.jpg"/> '.$pn[$i].'</a>';		
